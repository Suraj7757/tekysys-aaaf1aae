      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Track your repairs, browse shops, manage rewards.
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="flex gap-2">
            <Input
              placeholder="Enter tracking ID e.g. JSAM0042K9X"
              value={trackingId}
                ...
                {orders.map((o) => (
                  <TableRow key={o.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          o.status === "converted" ? "default" : "outline"
                        }
                      >
                        {o.status}
                      </Badge>
          ...
          <CardContent>
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {shops.map((s) => (
                <Card
                  key={s.user_id}
                  className="border-2 hover:border-primary/50 transition"
                >
                  <CardContent className="p-4 space-y-2">
                    ...
                    {s.booking_slug && (
                      <Button
                        ...
                        className="w-full"
                      >
                        <Link to={`/book/${s.booking_slug}`}>Book Repair</Link>
                      </Button>
                    )}
                  </CardContent>
                </Card>
