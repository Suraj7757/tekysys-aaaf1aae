...
export default function AdminRefunds() {
  const {
    ...
    loading,
    refetch,
  } = useSupabaseQuery<any>("payment_refunds");
                ...
                >
                  ...
                  <td className="p-3">
                    <div>
                      ...
                      <p className="text-[10px] text-muted-foreground">
                        of ₹{Number(r.original_amount).toLocaleString()}
                      </p>
                    </div>
                  </td>
                  <td
                    className="p-3 text-xs max-w-28 truncate"
                  ...
                  <td className="p-3">
                    <Badge
                      className={`${methodBadge[r.refund_method] || "bg-muted text-muted-foreground"} border-0 text-[10px] capitalize`}
                    >
                      {r.refund_method || "—"}
                    </Badge>
                  </td>
                  <td className="p-3">
                    <Badge
                      className={`${statusBadge[r.status] || "bg-muted"} border-0 text-[10px] capitalize`}
                    >
                      {r.status}
                    </Badge>
                  </td>
