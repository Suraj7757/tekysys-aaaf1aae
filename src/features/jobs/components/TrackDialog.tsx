        ...
        <div className="bg-gradient-to-br from-indigo-600 to-violet-700 p-8 text-white">
          ...
          <div className="mt-6 flex gap-2">
            ...
            <Button
              onClick={handleTrack}
              disabled={loading}
              className="bg-white text-indigo-600 hover:bg-white/90 h-12 px-6 rounded-xl font-bold shadow-lg"
            >
        ...
        <div className="p-8 min-h-[200px] flex flex-col justify-center items-center bg-background">
          ...
          {error && (
            <div className="text-center space-y-2 animate-in fade-in zoom-in-95">
              <div className="h-12 w-12 bg-red-50 text-red-500 rounded-full flex items-center justify-center mx-auto mb-2">
                ✕
              </div>
            ...
            <div className="w-full space-y-6 animate-in slide-in-from-bottom-4 duration-500">
              <div className="flex justify-between items-start border-b border-muted pb-4">
                <div>
                  ...
                  <Badge
                    className={`mt-1 font-bold ${statusColors[result.status] || "bg-muted"} border-0`}
                  >
                    {result.status}
                  </Badge>
                </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="font-bold text-sm">
                    {result.device_model || result.item_name || "N/A"}
                  </p>
                </div>
              </div>
              ...
              <Button
                ...
                className="w-full h-12 rounded-xl font-bold bg-muted text-foreground hover:bg-muted/80"
              >
                Close
              </Button>
            </div>
