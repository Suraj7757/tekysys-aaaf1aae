      ...
      <div className="p-6 max-w-5xl mx-auto space-y-6">
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-2">
            <CalendarCheck className="h-7 w-7 text-primary" /> Customer Bookings
          </h1>
          <p className="text-muted-foreground text-sm mt-1">
            Public link for customers to submit repair requests.
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <Label>Enable public booking page</Label>
                    ...
                    <div className="flex gap-2 pt-1 flex-wrap">
                      ...
                      {b.status === "converted" && b.converted_job_id && (
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            navigate(`/jobs?search=${b.converted_job_id}`)
                          }
                        >
        ...
        <Dialog open={convertOpen} onOpenChange={setConvertOpen}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Convert to Repair Job</DialogTitle>
            </DialogHeader>
            {convertBooking && (
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-muted/50 text-sm">
                  <p>
                    <b>{convertBooking.customer_name}</b> ·{" "}
                    {convertBooking.customer_mobile}
                  </p>
                  <p className="text-muted-foreground">
                    {convertBooking.device_brand} {convertBooking.device_model}
                  </p>
                ...
                <div>
                  ...
                  <Input
                    value={convertForm.technician_name}
                    onChange={(e) =>
                      setConvertForm({
                        ...convertForm,
