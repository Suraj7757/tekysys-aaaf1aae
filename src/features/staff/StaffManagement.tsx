        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1 font-medium">
              Manage your shop's technicians, receptionists and admins.
            </p>
          </div>
          <Button
            onClick={() => setIsAddOpen(true)}
            className="rounded-xl font-bold px-6 shadow-lg shadow-primary/20 gap-2"
          >
                ...
                {staffMembers?.map((member: any, i: number) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <div className="space-y-1">
                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                          ...
                          <span>staff-{i + 1}@repairxpert.com</span>
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
                      <Badge
                        className={`rounded-lg px-2 py-0.5 font-bold uppercase text-[10px] ${member.role === "admin" ? "bg-primary/20 text-primary border-primary/20" : "bg-muted text-muted-foreground"}`}
                      >
                        {member.role}
                      </Badge>
                    </TableCell>
                    <TableCell>
                      <Badge
                        variant="outline"
                        className="text-green-600 border-green-600/20 bg-green-500/5 gap-1.5 px-2"
                      >
          ...
          <DialogContent className="max-w-md rounded-3xl p-0 overflow-hidden border-0 shadow-2xl">
            <div className="gradient-primary p-6 text-center">
              ...
              <DialogDescription className="text-primary-foreground/70 font-medium">
                Invite a new member to join your shop dashboard.
              </DialogDescription>
            </div>
                ...
                >
                  ...
                  <SelectContent className="rounded-xl">
                    <SelectItem value="staff">
                      Technician (Can manage jobs)
                    </SelectItem>
                    <SelectItem value="receptionist">
                      Receptionist (Can manage customers)
                    </SelectItem>
